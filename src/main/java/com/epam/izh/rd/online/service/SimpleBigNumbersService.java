...
public class SimpleBigNumbersService implements BigNumbersService {
    ...
    public BigDecimal getPrecisionNumber(int a, int b, int range) {
        BigDecimal aValue = BigDecimal.valueOf(a);
        aValue = aValue.divide(BigDecimal.valueOf(b), range, BigDecimal.ROUND_DOWN);
        return aValue;
    }
    ...
    public BigInteger getPrimaryNumber(int range) {
        ...
        array.add(BigInteger.valueOf(3));
        while(array.size() != range + 1){
